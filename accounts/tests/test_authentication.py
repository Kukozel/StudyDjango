...
from accounts.authentication import (
    PERSONA_VARIFY_URL,DOMAIN,PersonaAuthenticationBackend
)
...
class AuthenticateTest(TestCase):
    ...
    def test_sends_asssertion_to_mozilla_domain(self,mock_post):
    ...
    def test_create_new_user_is_necessary_for_valid_assertion(self,mock_post):
        mock_post.return_value.json.return_value={'status':'okay','email':'a@b.com'}
        found_user=self.backend.authenticate('an assertion')
...
class GetUserTest(TestCase):
    def test_gets_user_by_email(self):
        ...
        other_user=User(email='otheruser@user.com')
